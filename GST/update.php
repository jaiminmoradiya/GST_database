...
<body>
  ...
  <form action="up.php" method="post">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="inputPassword4" placeholder="GSTIN Number" name="nm">
      </div>
      
      <div class="form-group col-md-6">
        <label for="inputPassword4">New Email</label>
        <input type="text" class="form-control" id="inputPassword4" placeholder="GSTIN Number" name="ne">
      </div>
